    ...
    <section className="text-black-primary">
      ...
      <div className="mx-auto mb-12 mt-8 flex flex-col items-center justify-center md:gap-10 lg:flex-row">
        ...
        <p className="mt-5 text-justify text-base text-secondary-text md:mt-0 lg:w-1/2 xl:text-lg">
          Hi, my name is Evan, and I’m an{' '}
          <b>Informatics Engineering</b> at Widyagama University.
          Besides studying, I also work as a <b>freelancer.</b>{' '}
          I have a strong passion for technology, particularly in <b>web development</b>.
          and I’m always excited to learn more and improve my skills in this field.
          <br />
          <br />Currently, I am learning <b>ReactJS</b> for the <b>Front-End</b>{' '}
          , and <b>NodeJS</b> for backend development.
        </p>
      </div>
      <TextSection
        icon="🏫"
