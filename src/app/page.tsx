    ...
    >
      ...
      >
        ...
        <p className="max-w-lg text-center text-sm dark:text-white md:max-w-2xl md:text-left md:text-base">
          I am a <b> Front-End Developer</b> from Indonesia, im still a beginner here in the world of programming and i have experience in{' '}
          <b>Web Development</b> projects.
        </p>
